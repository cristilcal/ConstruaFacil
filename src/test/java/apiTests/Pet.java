...
public class Pet {
    ...
    public void incluirPet() throws IOException { // Create - Post
        ...
        given()                                                 //Dado
                ...
                .body("name", is("Cocada"))            // Valida o nome do animal
    ...
    @Test(priority = 1, dependsOnMethods = {"alterarPet"})
    public void apagarPet(){
        ...
        given()
                ...
                .log().all()
        .when()
                .delete(uri + "/" + petId) // Get == Consultar
        .then()
                .log().all()
                .statusCode(200)
                .body("code", is(200))
